/* 
http://pat.zju.edu.cn/contests/pat-b-practise/1015 µÂ²ÅÂÛ 
*/  
...
bool compare(student a,student b) //±È½ÏaÔÚbÇ°Ôò·µ»Øtrue,±íÊ¾aÔÚbÇ°Ãæ  
{  
...
int main()  
{  
   vector<student> v1,v2,v3,v4;//±íÊ¾ËÄÀà¿¼Éú  
    student stu;//Ñ§ÉúÐÅÏ¢ÁÙÊ±±£´æ  
   int count=0;//´ï±êµÄÑ§Éú×ÜÊý  
    int N,L,H;  
